...
//   Do predictions, map observed responses (following tow model)
  var predictions = map(function(contingency){
    return(map(function(mechanism){
      ...
      // return avg predicted resp for each cond (not implemented yet)
...
result_direct %>%
  ...
  geom_point(data = data.frame(mechanism = c("direct","indirect"), prior_a = c(5,2), prior_b=c(2,5)), color = "red") +
